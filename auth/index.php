...
<div class="w3-container-fluid pageral">
    <div class="w3-col">
        ...
        <div class="w3-row alert w3-show">
            <!-- Mensagem de Alerta -->
        ...
        <div class="w3-row main w3-show">
            ...
            if ($user_authenticated) {
                // Inclui o conteúdo específico da página dentro da área restrita
                include './dashboard.php'; // Por exemplo, aqui você incluiria o conteúdo da dashboard
            } else {
                // Se não estiver autenticado, pode redirecionar para a página de login ou exibir uma mensagem
        ...
        <div class="w3-row extras w3-show">
            <!-- Extras -->
